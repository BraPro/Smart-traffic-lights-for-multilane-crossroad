...
class TSimulation:
    ...
    def run(self, episode, epsilon):
        ...
        while self._step < self._max_steps:
            ...
            action,dgl = self._choose_action(current_state, epsilon, old_action)
    ...
    def _choose_action(self, state, epsilon, old_action):
        """
        ...
        if random.random() < epsilon:
            ...
            return self._Model.predict_one(state, old_action, traffic_volume, traffic_waiting, traffic_load) # the best action given the current state
